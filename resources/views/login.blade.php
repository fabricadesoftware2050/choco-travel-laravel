...
@section('content')
    @include("inc/popup")
    <div class="min-h-screen flex items-center justify-center bg-yellow-400 bg-opacity-80 px-4 py-12">
        <div class="flex flex-col md:flex-row bg-white rounded-lg shadow-md overflow-hidden max-w-4xl w-full">
            ...
            <div class="relative md:w-1/2 hidden md:block">
                ...
                <div class="absolute inset-0 bg-black bg-opacity-70 flex items-center justify-center">
                    <div class="text-center px-4">
                        <h2 class="text-white text-2xl font-bold mb-2">Sé parte de Choco Travel</h2>
            ...
            <div class="w-full md:w-1/2 p-6">
                ...
                <p class="text-sm text-center mt-4">
                    ¿Ya tienes una cuenta? <a href="#" class="text-blue-600 underline">Iniciar sesión</a>
                </p>
                <div class="mt-4">
